          ...
          <div className="relative h-[300px] sm:h-[400px] lg:h-auto group overflow-hidden">
            <div className="absolute inset-4 z-20 flex flex-col justify-between pointer-events-none">
              ...
              <div className="bg-secondary/60 backdrop-blur-md border border-white/10 p-4 md:p-6 rounded-2xl transform group-hover:translate-y-[-5px] transition-transform duration-500 max-w-[280px] md:max-w-none">
                <p className="text-white font-bold text-base md:text-lg mb-1 italic">
          ...
          <div className="p-6 sm:p-10 lg:p-16 space-y-8 flex flex-col justify-center">
            <div className="space-y-4 text-center lg:text-left">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white tracking-tighter leading-tight">
                Essential <span className="text-primary italic">Resources</span>{" "}
                <br />
              ...
              <p className="text-gray-400 text-base md:text-lg leading-relaxed max-w-md mx-auto lg:mx-0">
                Expanding our commitment to quality through reliable bulk water
                distribution and high-performance industrial detergents.
              </p>
            </div>
              ...
              {[
                {
                  icon: <Droplet />,
                  title: "Bulk Water",
                  desc: "Potable & Industrial",
                },
                {
                  icon: <Sparkles />,
                  title: "Detergents",
                  desc: "High-fidelity gear",
                },
                {
                  icon: <Truck />,
                  title: "Logistics",
                ...
                },
                {
                  icon: <ShieldCheck />,
                  title: "SABS Quality",
                  desc: "Safety guaranteed",
                },
              ].map((item, index) => (
                <div
                  key={index}
                  className="flex gap-4 items-center lg:items-start p-3 lg:p-0 rounded-xl bg-white/5 lg:bg-transparent border border-white/5 lg:border-none"
                >
            ...
            <div className="pt-4 flex justify-center lg:justify-start">
              <Button
                size="lg"
                className="w-full sm:w-auto rounded-full px-10 font-bold group h-14"
                asChild
              >
