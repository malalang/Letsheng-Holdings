  ...
  <Card className="group overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border-none bg-white flex flex-col">
    <div className="relative h-64 overflow-hidden">
      ...
      <div className="absolute top-4 right-4">
        <Badge className="bg-primary text-secondary font-bold px-3 py-1">
          Featured Estate
        </Badge>
      </div>
    </div>
...
const FeaturedProductCard = ({
  ...
  <Card className="group overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border-none flex flex-col">
      ...
      <Link href={`/branding/${id}`}>
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-secondary/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
          <p className="text-white text-sm font-medium">
            High-Fidelity Branding Solutions
          </p>
        </div>
      </Link>
    </div>
    ...
    <CardHeader>
      <Badge
        variant="outline"
        className="border-primary text-primary font-bold mb-2 w-fit uppercase text-[10px] tracking-widest"
      >
        {category}
      </Badge>
          ...
          <div className="space-y-6 md:space-y-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              ...
              <Button
                size="lg"
                variant="outline"
                className="h-14 md:h-16 px-8 md:px-10 text-base md:text-lg font-bold border-white/10 bg-primary/10 text-white hover:bg-white hover:text-secondary transition-all backdrop-blur-sm"
                asChild
              >
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg text-gray-600 leading-relaxed">
              Discover our premier properties in Mpumalanga and Gauteng,
              offering unparalleled comfort, private en-suites, and reliable
              utility security.
            </p>
          </div>
          <Button
            variant="ghost"
            className="text-primary font-bold hover:bg-primary/5 hover:text-secondary"
            asChild
          >
      ...
      <section className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg text-gray-600 leading-relaxed">
              Elevate your corporate identity with precision-crafted apparel,
              signage, and marketing materials designed for national impact.
            </p>
          </div>
          <Button
            variant="ghost"
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our success is defined by the satisfaction of the communities we
              serve.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Whether you're looking for a modern home or professional
                branding, our process is designed for speed and transparency.
              </p>
