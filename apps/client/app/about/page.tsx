  ...
  return (
    <div className="animate-fade-in space-y-24 pb-20">
      ...
      <header className="text-center pt-10 px-4">
        <Badge
          variant="outline"
          className="mb-4 py-1 px-4 text-primary border-primary/30 uppercase tracking-widest text-xs"
        >
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          premium housing, high-fidelity branding, and essential community
          services. We are driven by a simple philosophy:{" "}
      ...
      <main className="space-y-32">
            ...
            <Card className="shadow-xl border-none bg-gradient-to-br from-white to-gray-50">
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  To deliver innovative, affordable, and reliable services that
                  address the growing demand for housing, cleanliness, and water
                  security, while simultaneously empowering businesses through
                  high-quality branding materials. We prioritize customer
                  satisfaction and community wellbeing above all else.
                </p>
              </CardContent>
            </Card>
            <Card className="shadow-xl border-none bg-gradient-to-br from-white to-gray-50">
              ...
              <CardContent>
                <p className="text-gray-600 leading-relaxed">
                  To become South Africa's most trusted provider of modern
                  living spaces, impactful corporate branding, and reliable
                  essential services. We envision a future where our integrated
                  solutions make our clients' lives easier, more secure, and
                  highly successful.
                </p>
              </CardContent>
            </Card>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                At Letsheng Holdings, we believe that quality of life and
                business success are built on the same foundation: reliability.
                Whether we are providing a private sanctuary for a young
                professional or crafting the corporate identity for a growing
                firm, our approach remains the same—combining modern technology
        ...
        <InfoSection
          title="The Letsheng Advantage"
          subtitle="What sets our integrated divisions apart from the rest."
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto px-4">
            <div className="p-6 rounded-2xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                Our rental units prioritize your personal space with en-suite
                bathrooms and private facilities as standard.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                Equipped with Jojo tanks and backup systems, we ensure municipal
                outages don't disrupt your daily life.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                Our digital proofing and premium inks ensure 100% brand accuracy
            ...
            <div className="p-6 rounded-2xl bg-white shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">
                We maintain the infrastructure to deliver branding projects and
        ...
        <section className="bg-secondary/5 rounded-[3rem] py-20 px-6 mx-4">
          <InfoSection
            ...
            subtitle="Four divisions, one commitment to excellence."
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
              <Card className="border-none shadow-lg">
                ...
                <CardContent className="text-sm text-gray-600">
                  Modern, secure rental units tailored for the working class.
                  Includes en-suite bathrooms, carports, and consistent water
                  supply.
                </CardContent>
              </Card>
              ...
              <Card className="border-none shadow-lg">
                ...
                <CardContent className="text-sm text-gray-600">
                  Precision branding and marketing materials. We combine
                  technology and craftsmanship to deliver apparel, banners, and
                  more.
                </CardContent>
              </Card>
              ...
              <Card className="border-none shadow-lg opacity-80">
                ...
                <CardContent className="text-sm text-gray-600">
                  Industrial-grade bulk detergents for schools and offices.
                  Promoting nationwide hygiene at an affordable price point.
                </CardContent>
              </Card>
              ...
              <Card className="border-none shadow-lg opacity-80">
                ...
                <CardContent className="text-sm text-gray-600">
                  Safe, purified water distribution for rural communities and
                  businesses to ensure consistent water security.
                </CardContent>
              </Card>
            </div>
          </InfoSection>
        ...
        <InfoSection
          ...
          subtitle="Strategic expansion plans through 2029."
        >
        ...
        <InfoSection title="Our Core Values">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto px-4">
            <Pillar icon={<ShieldCheck className="h-8 w-8" />} title="Honesty">
              Building long-lasting trust through total transparency in every
              lease and every print project.
            </Pillar>
            <Pillar icon={<Lightbulb className="h-8 w-8" />} title="Innovation">
              Constantly upgrading our facilities and print technology to stay
              ahead of market demands.
            </Pillar>
            <Pillar icon={<Users className="h-8 w-8" />} title="Team Work">
              Uplifting South African communities through the collective effort
              of our diverse, talented team.
            </Pillar>
          </div>
        </InfoSection>
        ...
        <InfoSection
          ...
          subtitle="The minds behind our national expansion."
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group bg-secondary rounded-[2.5rem] p-12 text-white flex flex-col justify-between hover:scale-[1.02] transition-all duration-300 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-4xl text-primary font-bold mb-4 tracking-tight">
                  Looking for a Home?
                </h3>
                <p className="text-gray-300 text-lg mb-8 max-w-sm leading-relaxed">
                  Secure your spot in one of our private, modern rental units
                  today. Explore our latest vacancies.
                </p>
              </div>
              <Link
                href="/properties"
                className="relative z-10 inline-flex items-center text-primary text-xl font-bold hover:gap-3 transition-all"
              >
            ...
            <div className="group bg-primary rounded-[2.5rem] p-12 text-white flex flex-col justify-between hover:scale-[1.02] transition-all duration-300 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h3 className="text-4xl font-bold mb-4 tracking-tight text-secondary">
                  Need Branding?
                </h3>
                <p className="text-blue-100 text-lg mb-8 max-w-sm leading-relaxed">
                  From apparel to large scale signage, we bring your corporate
                  vision to life with high-fidelity printing.
                </p>
              </div>
              <Link
                href="/branding"
                className="relative z-10 inline-flex items-center text-secondary text-xl font-bold hover:gap-3 transition-all"
              >
