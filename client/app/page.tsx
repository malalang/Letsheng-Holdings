...
export default async function HomePage() {
  ...
  return (
    <div className="animate-fade-in space-y-32 pb-20">
      {/* Hero Header */}
      <header className="relative min-h-[85vh] flex items-center bg-secondary/20 rounded-[3rem] shadow-2xl overflow-hidden mx-4 mt-2 border border-white/5">
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            fill
            className="object-cover  grayscale-[50%] select-none"
            priority
          />
        ...
        <div className="relative z-10 container mx-auto px-8 py-24 grid items-center">
          ...
          <div className="space-y-10 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              <Button size="lg" className="h-16 px-10 text-lg font-bold shadow-[0_10px_20px_-10px_rgba(var(--primary),0.5)] transition-transform hover:scale-105" asChild>
                <Link href="/properties">Explore Estates</Link>
              </Button>
              <Button size="lg" variant="outline" className="h-16 px-10 text-lg font-bold border-white/10 bg-primary text-white hover:bg-white hover:text-secondary transition-all" asChild>
                <Link href="/branding">Branding Solutions</Link>
              </Button>
            </div>

            <div className="pt-6 flex items-center justify-center lg:justify-start gap-8 text-gray-500 border-t border-white/5 w-fit">
              <div className="text-center">
                <p className="text-white font-bold text-xl">100%</p>
                <p className="text-[10px] uppercase tracking-widest">Reliability</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                <p className="text-white font-bold text-xl">ZA</p>
                <p className="text-[10px] uppercase tracking-widest">National</p>
              </div>
            </div>
          </div>

          {/* Right Column: Visual Features Grid */}
