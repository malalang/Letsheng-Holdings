      ...
      <ol className="space-y-4 text-sm">
        <li className="flex items-start">
          ...
          <div>
            ...
            provide a tailored quote and timeline.
          </div>
        </li>
        <li className="flex items-start">
          <strong className="bg-brand-Blue text-brand-navy rounded-full h-8 w-8 text-center shrink-0 leading-8 font-bold mr-4">
          ...
          <div>
            ...
            approval and can request final adjustments before production.
          </div>
        </li>
        <li className="flex items-start">
          <strong className="bg-brand-Blue text-brand-navy rounded-full h-8 w-8 text-center shrink-0 leading-8 font-bold mr-4">
          ...
          <div>
            <strong>Production & Fulfillment:</strong> After approval and
            payment, we move into production and manage fulfillment end-to-end.
          </div>
        </li>
      </ol>
    </CardContent>
