...
import { propertySchema, type Property } from '@/lib/validations/schemas';
              ...
              <Card className="mb-4">
               ...
               <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Rent is due by the 7th of each month. Leases are subject to termination after 3 months of non-payment.
                    </CardDescription>
                </CardHeader>
            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                                    ...
                                    <div className="w-full">
                                        {form.watch('image_url') ? (
                                            <div className="relative aspect-video w-full max-w-lg overflow-hidden rounded-lg border">
                                                <Image src={form.watch('image_url')} alt="Main property preview" fill className="object-cover" />
                                                <Button
                                                    type="button"
                                                    variant="destructive"
                                                    size="icon"
                                                    className="absolute top-2 right-2"
                                                    onClick={() => form.setValue('image_url', '', { shouldValidate: true, shouldDirty: true })}
                                                >
                                            ...
                                            <div className='flex w-full max-w-lg justify-center rounded-lg border border-dashed border-gray-300 px-6 py-10'>
                                                <div className='text-center'>
                                                    ...
                                                    <p className='text-xs text-gray-500'>Paste an image URL below to set the main image.</p>
                                                </div>
                                            </div>
                                        )}
                                        <Input
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Manage the collection of images for the property.</p>
                        <div className="space-y-6 mt-4">
                            {fields.map((field, index) => (
                                <Card key={field.id} className="overflow-hidden">
                                    <CardHeader className="flex flex-row items-center justify-between py-4">
                                        <CardTitle className="text-lg">Gallery Item {index + 1}</CardTitle>
                                        <Button
                                            type="button"
                                            variant="ghost"
                                            size="icon"
                                                        ...
                                                        <div className="w-full">
                                                            {form.watch(`gallery.${index}.imageUrl`) ? (
                                                                <div className="relative aspect-video w-full max-w-md mx-auto overflow-hidden rounded-lg border">
                                                                    <Image src={form.watch(`gallery.${index}.imageUrl`)} alt={`Gallery item ${index + 1}`} fill className="object-cover" />
                                                                </div>
                                                            ) : (
                                                                <div className='flex w-full max-w-md mx-auto justify-center rounded-lg border border-dashed border-gray-300 px-6 py-10'>
                                                                    <div className='text-center'>
                                                                        <Upload className='mx-auto h-12 w-12 text-gray-400' />
                                                                        <p className='mt-4 text-sm text-gray-600'>No image for this item.</p>
                        ...
                        <Button
                            ...
                            size="sm"
                            className="mt-6"
                            onClick={() => append({ imageUrl: '', title: '', description: '' })}
                        >
