    ...
    <div className="animate-fade-in text-white">
      ...
      <header className="mb-8">
        ...
        <p className="text-lg text-gray-400 mt-1">
          {property.id} &bull; {property.location}
        </p>
      </header>
        ...
        <div className="lg:col-span-2 space-y-8">
          <Card className="bg-brand-navy/50 border-brand-gold/20 backdrop-blur-md">
            ...
            <CardContent className="grid grid-cols-2 gap-6">
              ...
              />
              <Badge className="bg-emerald-500/20 text-emerald-400 border-emerald-500/50 w-full col-span-2 justify-center py-2">
                Lease Active
              </Badge>
            </CardContent>
          </Card>
          ...
          <Card className="bg-brand-navy/50 border-brand-gold/20 backdrop-blur-md">
            ...
            <CardContent className="grid grid-cols-2 gap-6">
              <DetailRow
                icon={<DollarSign />}
                label="Monthly Rate"
                value={`R ${property.monthly_rate.toLocaleString()}`}
              />
              <DetailRow
                icon={<DollarSign />}
        ...
        <div className="space-y-8">
          ...
          <Card className="bg-brand-navy/50 border-brand-gold/20 backdrop-blur-md">
            ...
            <CardContent className="space-y-3">
              <Button className="w-full justify-start bg-white/10 border-white/20 hover:bg-white/20">
